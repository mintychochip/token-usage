...
| 2026-08-19 | GitHub is one remote: `publish`/`pull` via gist (`gh`) or a directory; a central widget service may also be used | Ingest stays FileStore; public publishes are signed summaries, not raw sessions |
